    ...
    $(document).ready(function () {
        ...
        var productTable = $('#product_data').bootgrid({
            ...
            formatters: {
                ...
                {
                    return "<button type='button' class='btn btn-warning btn-xs update' data-row-id='"+row["USER_ID"]+"'>Edit</button>" +
                        "&nbsp; <button type='button' class='btn btn-danger btn-xs delete' data-row-id='"+row["USER_ID"]+"'>Delete</button>";
                }
            }
        });
