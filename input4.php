...
<head>
  ...
  <meta name="viewport" content="width=device-page-wrapperwidth, initial-scale=1, shrink-to-fit=no">bootstrap
  ...
  <link href="vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
    ...
    <link href="vendor/bootgrid/css/jquery.bootgrid.css" rel="stylesheet" />
    <script src="vendor/jquery-1.11.1.min.js"></script>
    <script src="vendor/bootgrid/js/jquery.bootgrid.min.js"></script>
                      ...
                      <div class="panel-body">
                          ...
                          <div class="table-responsive">
                              <table id="product_data" class="table table-bordered table-striped">
                                  <thead>
                                  <tr>
                                      <th data-column-id="id_contract" data-type="numeric">ลำดับ</th>
                                      <th data-column-id="contractdesc">เลขที่สั่งซื้อ</th>
                                      <th data-column-id="contractdate">วันที่สั่งซื้อ</th>
                                      <th data-column-id="contracteffec">ชื่อลูกค้า </th>
                                      <th data-column-id="mainproduct">ที่อยู่จัดส่ง </th>
                                      <th data-column-id="subproduct">วันที่จัดส่ง </th>
    ...
    $(document).ready(function () {
        ...
        var productTable = $('#product_data').bootgrid({
            ...
            formatters: {
                ...
                {
                    return "<button type='button' class='btn btn-warning btn-xs update' data-row-id='"+row["id_contract"]+"'>Edit</button>" +
                        "&nbsp; <button type='button' class='btn btn-danger btn-xs delete' data-row-id='"+row["id_contract"]+"'>Delete</button>";
                }
            }
        });
...
<div id="productModal" class="modal fade">
    <div class="modal-dialog">
      ...
      <?php //echo $output; ?>
                    ...
                    <label>กรอก USERNAME</label>
                    <input type="text" name="USER_ID" id="USER_ID" class="form-control" />
                    <br />
                    <label>กรอก รหัส</label>
                    <input type="text" name="PASSWORD" id="PASSWORD" class="form-control" />
                    <br />
                    <label>กรอก ชื่อ</label>
                    <input type="text" name="FIRSTNAME" id="FIRSTNAME" class="form-control" />
                    <br />
                    <label>กรอก นามสกุล</label>
                    <input type="text" name="LASTNAME" id="LASTNAME" class="form-control" />
                    <br />
                    <label>กรอก เบอร์โทร</label>
                    <input type="text" name="TEL" id="TEL" class="form-control" />
                    <br />
                    <label>กรอก ที่อยู่</label>
                    <input type="text" name="ADDRESS" id="ADDRESS" class="form-control" />
                    <br />
                    <label>กรอก สิทธิ</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" name="action" id="action" class="btn btn-success" value="Add_USER" />
                    </div>
                </div>
        </form>
    </div>
